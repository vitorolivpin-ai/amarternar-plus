...
const conteudos = [
  { id: 1, title: 'Pega correta na amamentação', source: 'Ministério da Saúde', type: 'article', category: 'breastfeeding', description: 'Guia completo sobre como posicionar o bebê para uma amamentação eficaz.' },
  { id: 2, title: 'Primeiros dias com o bebê', source: 'Sociedade Brasileira de Pediatria', type: 'article', category: 'babyCare', description: 'O que esperar e como cuidar do seu recém-nascido.' },
  { id: 3, title: 'Como aumentar a produção de leite', source: 'Organização Mundial da Saúde', type: 'video', category: 'breastfeeding', description: 'Dicas práticas para estimular a produção de leite materno.' },
  { id: 4, title: 'Autocuidado no puerpério', source: 'Ministério da Saúde', type: 'article', category: 'motherCare', description: 'A importância de cuidar de si mesma durante o pós-parto.' },
  { id: 5, title: 'Sinais de depressão pós-parto', source: 'CVV', type: 'article', category: 'mentalHealth', description: 'Como identificar e buscar ajuda para a depressão pós-parto.' },
  { id: 6, title: 'Banho do recém-nascido', source: 'Sociedade Brasileira de Pediatria', type: 'video', category: 'babyCare', description: 'Passo a passo para dar banho no bebê com segurança.' },
];
        ...
        {filteredContent.map(item => {
          ...
          return (
            <div key={item.id} className="bg-white rounded-2xl p-4 shadow-sm border border-[#E6E6FA]/30">
              ...
              <button className="w-full mt-3 py-2 bg-gradient-to-r from-[#FFDAB9]/30 to-[#E6E6FA]/30 text-[#B8A9C9] rounded-xl text-base font-medium hover:from-[#FFDAB9]/50 hover:to-[#E6E6FA]/50 transition-all flex items-center justify-center gap-2"><ExternalLink className="w-4 h-4" />Acessar conteúdo</button>
            </div>
          );
        })}
