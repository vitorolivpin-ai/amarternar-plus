...
const careSteps: CareStep[] = [
  ...
  {
    id: 5,
    title: "Mantenha o hábito",
    subtitle: "Repita o que funciona para você e seu bebê.",
    icon: "💛",
  ...
  function toggleCompleted(id: number) {
    setCompletedSteps((previous) =>
      previous.includes(id)
        ? previous.filter((stepId) => stepId !== id)
        : [...previous, id]
    );
  }
      ...
      <div className="rounded-3xl bg-gradient-to-br from-pink-500 to-rose-400 p-6 text-white shadow-lg">
        <div className="mb-3 flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className="text-2xl font-bold">Cuidados Inteligentes</h1>
          </div>
        </div>

        <p className="text-sm leading-6 text-pink-50">
          Pequenos cuidados para deixar o momento da amamentação mais
          confortável, organizado e tranquilo.
        </p>
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  >
                    <span>{isOpen ? "Ocultar dicas" : "Ver dicas simples"}</span>
